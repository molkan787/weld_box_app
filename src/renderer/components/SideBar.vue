<template>
  <div class="side-bar pane">
    <div class="icon" :class="{active: activeTool == 'state'}" draggable @dragstart="dragStart">
      <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.6" y="0.6" width="15.8" height="11.8" rx="1.4" fill="#C4C4C4" stroke="#808080" stroke-width="1.2"/>
      </svg>
    </div>
    <div class="icon" :class="{active: activeTool == 'transition'}" @click="iconClick('transition')">
