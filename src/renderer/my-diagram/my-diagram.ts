...
export class MyDiagram extends Diagram{
  ...
  buildTestDiagram(){
    ...
    const node2 = new State({ x: 20, y: 150 }, { width: 240, height: 120, radius: 0 }, { title: 'Child 1' });
    const node3 = new State({ x: 450, y: 180 }, { width: 240, height: 120, radius: 0 }, { title: 'Child 2' });
